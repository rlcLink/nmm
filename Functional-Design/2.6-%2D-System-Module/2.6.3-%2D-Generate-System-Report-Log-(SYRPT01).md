<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/294/" target="_blank">2.6.3 - Generate System Report Log (SYRPT01)</a> - This function produces a listing of all reports produced by the NMMSS.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/789/" target="_blank">SYSPR016</a> - The NMMSS shall be able to produce a system report log (daily output report updating batch number listing) that will list all reports produced by the NMMSS. This report will list the name of the report, report destination, date, time, classification level of the report, receiving contact key, receiving RIS, and the responsible RIS. The user will have the option to list only reports that have been ADCed, QCed, and/or logged (SYRPT01).