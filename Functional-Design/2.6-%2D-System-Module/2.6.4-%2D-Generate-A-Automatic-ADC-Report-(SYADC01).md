<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/295/" target="_blank">2.6.4 - Generate A Automatic ADC Report (SYADC01)</a> - This function produces a report that shows all of the reports that are marked as A automatic ADC reports that have not been ADCed.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/790/" target="_blank">SYSRPT1</a> - The NMMSS shall have the ability to produce a report that will show all of the reports that are marked as A automatic ADC reports that have not been ADCed. (SYADC01).