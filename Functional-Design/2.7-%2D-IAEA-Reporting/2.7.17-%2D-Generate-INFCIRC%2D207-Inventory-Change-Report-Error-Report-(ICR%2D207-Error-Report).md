This function produces a formatted report containing errors found in the
...
- IAEARPT6 - The NMMSS shall have the ability to produce an ICR- 207 error report which will contain errors found in the tag data list file (ICR-207 Error Report).
