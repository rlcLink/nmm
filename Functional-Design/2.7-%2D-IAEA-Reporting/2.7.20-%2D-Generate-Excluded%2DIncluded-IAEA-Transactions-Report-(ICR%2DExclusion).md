...
- IAEARPT13 - The NMMSS shall have the ability to produce a listing of excluded/included IAEA transactions report that will include the following information: IAEA facility, transfer series, action date, exclude/include date, change comments and reported flag.

- IAEARPT23 - The NMMSS shall have the ability to produce a listing of excluded/included IAEA transactions (ICR-Exclusion). The following information will be included in this report: reporting period, IAEA facility, transfer series, action date, exclude/include date, change comments, and reported flag.
