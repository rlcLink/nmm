<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/300/" target="_blank">2.7.1 - Generate INFCIRC-288 Inventory Change Report Concise Notes Report (CN-288)</a> -This function produces a formatted report of concise notes as they pertain to the INFCIRC/288 Inventory Report.
...
- <a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/456/" target="_blank">IAEARPT1</a>  - The NMMSS shall have the ability to produce an INFCIRC/288 inventory change report concise notes report that will list concise note information as it pertains to the INFCIRC/288 Inventory Change Report. Important items that will be shown on this report are IAEA facility code, report number, entry number, cross reference entry number (the ICR entry on which the concise note appears), and the concise note text (CN-288).
