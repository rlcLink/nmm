...
- IAEARPT15 - The NMMSS shall have the ability to produce a MBR-288 error report (IA-MBR-288-ERR) which will consist of errors found in the MBR tag data list file.
