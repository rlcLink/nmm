<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/204/" target="_blank">2.3.11 - Generate Authorized Inventory Profile by Facility Report (I-017D)</a> -This function describes the composition of ending inventory descriptions authorized by DOE for facility use.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/722/" target="_blank">INVRPT11 </a> -The NMMSS shall have the ability to produce an inventory listing report that will list inventory for a specific RIS (I-10E). The NMMSS shall have the ability to produce an inventory data categories report (1-017, 1-017C) that will identify all available, active, and authorized composition of ending inventory descriptions for use by contractors in reporting data on inventories of nuclear materials. Inventory descriptions will be listed in a tabular format and arranged in logical groupings according to usage, process, chemical and physical form.
