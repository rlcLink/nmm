...
- INVRPTT1 - The NMMSS shall have the ability to produce ail inventory data categories report (1-017, 1-017C) that will identify all available, active, and authorized composition of ending inventory descriptions for use by contractors in reporting data on inventories of nuclear materials. Inventory descriptions will be listed in a tabular format and arranged in logical groupings according to usage, process, chemical and physical form.
