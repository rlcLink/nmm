...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/730/" target="_blank">INVRPT17 </a> - The NMMSS shall have the ability to produce a composition of ending inventory by facility with cost report (I-027C) which will describe the inventories of nuclear material held by facilities including the inventory detail information as reported. This report will also include financial information for each inventory item for a facility. Balance sheet code, dollar values without depreciation, and total dollar costs will be supplied based on current cost designations.
