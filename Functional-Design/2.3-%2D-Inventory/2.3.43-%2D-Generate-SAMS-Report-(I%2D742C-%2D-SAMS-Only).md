<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/236/" target="_blank">2.3.43 - Generate SAMS Report (I-742C - SAMS Only)</a>-This function produces a formatted report of the entire inventory for a RIS, inventory date, and a specified material type.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/739/" target="_blank">INVRPT46 </a> - The NMMSS shall have the ability to produce a report (I-742C) that will list the entire inventory for a RIS, inventory date, and material type. The report allows the user to specify which material type to select data for.
