...
- INVRPT46 - The NMMSS shall have the ability to produce a report (I-742C) that will list the entire inventory for a RIS, inventory date, and material type. The report allows the user to specify which material type to select data for.
