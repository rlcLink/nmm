<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/198/" target="_blank">2.3.5 - Generate Detailed Error Report (I-006M)</a> -This function produces a formatted report of error rates and counts for a specified R1S. The report will break out the errors by type and list a brief description for each error.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/719/" target="_blank">INVRPT4 </a> - The NMMSS shall have the ability to produce a detailed error report (I-006M) by date report that will list error rates and counts for specified RIS's. This report will break out the errors by type and list a brief description for each error.
