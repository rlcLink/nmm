...
- INVRPT4 - The NMMSS shall have the ability to produce a detailed error report (I-006M) by date report that will list error rates and counts for specified RIS's. This report will break out the errors by type and list a brief description for each error.
