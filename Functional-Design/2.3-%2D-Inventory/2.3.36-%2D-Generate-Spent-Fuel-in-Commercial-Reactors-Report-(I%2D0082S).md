...
- INVRPT41 - The NMMSS shall have the ability to produce a spent fuel in commercial reactors report (I-0082S) that will list commercial licensee power reactor inventories for composition code 861 and material types Uranium/Plutonium. [Note: This report is not regularly used by the NMMSS or distributed to NMMSS customers]
