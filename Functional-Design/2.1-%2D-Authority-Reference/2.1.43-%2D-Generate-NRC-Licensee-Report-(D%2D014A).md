...
- AURPT7 - The NMMSS shall be able to produce an unassigned RIS's that may be used by NRC licensee report (D-014A) that will list available RIS's that can be assigned to a new licensee.
