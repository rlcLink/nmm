<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/123/" target="_blank">2.1.34 - Generate Distribution List (D-042A)</a> - This function produces for a specific report a distribution listing for appearance on mailing label.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/485/" target="_blank">AURPT17</a> - The NMMSS shall be able to produce a distribution listing for a specific report that will list all individual contacts on distribution for a specified report. The report will list each contact name with complete address, RIS and number of copies received, exactly as these items will appear on the mailing label (D-042A).
