This function produces a formatted report that shows all explanations of inventory difference data found to be in error when updating the current inventory difference master file.
