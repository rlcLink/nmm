<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/264/" target="_blank">2.5.12 - Generate Inventory Difference Update File Error List Report (FI-003)</a>- This function produces a formatted report that shows all explanations of inventory difference data found to be in error when updating the current inventory difference master file.
