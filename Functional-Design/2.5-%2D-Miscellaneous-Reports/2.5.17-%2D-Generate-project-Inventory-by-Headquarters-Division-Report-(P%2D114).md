<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/269/" target="_blank">2.5.17 - Generate project Inventory by Headquarters Division Report (P-114)</a>- This function produces a formatted report containing information on all material in all projects of each program utilizing nuclear material.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/780/" target="_blank">RPT17 </a> -The NMMSS shall have the ability to produce a project inventory by headquarters division report (P-114) that will contain information on all material in all projects of each program utilizing nuclear material. The report will be based on the reported inventory data by contractor facilities and computed for licensed facilities and are grouped based upon the configuration of the project number.
