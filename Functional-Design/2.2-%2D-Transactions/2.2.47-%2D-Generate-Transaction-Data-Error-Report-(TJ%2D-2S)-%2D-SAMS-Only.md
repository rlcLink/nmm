<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/185/" target="_blank">2.2.47 - Generate Transaction Data Error Report (TJ- 2S) - SAMS Only</a> - This function produces an error report that identifies each data discrepancy detected in the initial data input and edit processing stage.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/671/" target="_blank">TRPR0104</a> - SAMS will allow a user to run the TJ-002 report with the ability to process errors prior to generating the report. (TJ-2S in SAMS)
