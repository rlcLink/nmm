...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/646/" target="_blank">TRRPT7 </a> -The NMMSS shall be able to produce a transaction conditional data error report (TJ-002A) (distributed simultaneously with the TJ-001 and TJ-002). This report will identify each conditional data discrepancy detected in the initial data input and edit processing phase. These transactions will continue to the database updating process due to the non-fatal nature of the discrepancies.
