...
- TRRPT24 - The NMMSS shall be able to produce a transaction receipt history report (TJ-006F) that looks for a requested transfer series and returns all dates that the record was processed through the NMMSS.