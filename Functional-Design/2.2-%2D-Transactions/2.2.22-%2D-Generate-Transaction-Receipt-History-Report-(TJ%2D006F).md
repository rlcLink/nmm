<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/160/" target="_blank">2.2.22 - Functional Requirement: Generate Transaction Receipt History Report (TJ-006F)</a> - This function produces a formatted report of all dates a record was processed for a requested transfer series.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/654/" target="_blank">TRRPT24 </a> - The NMMSS shall be able to produce a transaction receipt history report (TJ-006F) that looks for a requested transfer series and returns all dates that the record was processed through the NMMSS.
