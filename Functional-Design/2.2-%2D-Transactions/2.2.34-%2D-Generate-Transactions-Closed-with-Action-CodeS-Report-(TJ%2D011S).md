...
- TRRPT53 - The NMMSS shall be able to produce a transactions closed with action code S report (TJ-01 IS) which will show all transactions closed with action code S for any selected RIS for any desired period that have not been answered with a B or E action code.