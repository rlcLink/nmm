<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/180/" target="_blank">2.2.42 - Generate Export License Number Monitor Report (TJ-110)</a> - This function produces a formatted report of export authorizations and related transactions for license numbers.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/667/" target="_blank">TRRPT69 </a> - The NMMSS shall be able to produce an export license number monitor report (TJ-110) that lists export authorizations and related transactions for license numbers. The report serves as a monitor for all transfers of special nuclear material based on quantity authorizations by a license number.
