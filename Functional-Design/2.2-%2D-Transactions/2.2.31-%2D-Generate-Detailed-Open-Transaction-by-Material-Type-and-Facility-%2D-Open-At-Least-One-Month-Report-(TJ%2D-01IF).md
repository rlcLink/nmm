<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/169/" target="_blank">2.2.31 - Generate Detailed Open Transaction by Material Type and Facility - Open At Least One Month Report (TJ- 01IF)</a> - This function produces a formatted report of open transactions on request through the survey and inspection package.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/660/" target="_blank">TRRPT51 </a> - The NMMSS shall be able to produce a detailed open transaction by material type and facility - open at least one month report (TJ-01 IF) which will be produced for open transactions on request through the survey and inspection package. The report highlights shipments to the receiving facility for which the receiver's closing data has not been reported to the system and the elapsed time since shipment equals or exceeds 30 days.
