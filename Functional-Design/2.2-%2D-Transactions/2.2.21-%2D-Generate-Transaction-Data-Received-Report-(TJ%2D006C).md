<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/159/" target="_blank">2.2.21 - Functional Requirement: Generate Transaction Data Received Report (TJ-006C)</a> - This function produces a formatted report that summarizes the data receipts by facility or operations office/organization reporting the data.
...
- TRRPT23 - The NMMSS shall be able to produce a transaction data received report (TJ-006C) that summarizes the data receipts by facility or operations office/organization reporting the data. Data receipts are totaled according to the day of the month received.