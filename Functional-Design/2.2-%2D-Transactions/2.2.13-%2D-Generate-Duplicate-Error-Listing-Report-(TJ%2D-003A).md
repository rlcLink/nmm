...
- TRRPT9 - The NMMSS shall be able to produce a duplicate error listing report (TJ-003A) that will be list all received and processed transactions with duplicate errors.