<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/151/" target="_blank">2.2.13 - Functional Requirement: Generate Duplicate Error Listing Report (TJ-003A)</a> - This function produces a formatted report of all received and processed transactions with duplicate errors.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/647/" target="_blank">TRRPT9 </a> - The NMMSS shall be able to produce a duplicate error listing report (TJ-003A) that will be list all received and processed transactions with duplicate errors.
