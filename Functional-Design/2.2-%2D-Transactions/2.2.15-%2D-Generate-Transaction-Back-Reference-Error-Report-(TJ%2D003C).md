...
- TRRPT11 - The NMMSS shall be able to produce a transaction back reference error report (TJ-003C) that lists back reference errors that were generated as a result of the back reference edit process.