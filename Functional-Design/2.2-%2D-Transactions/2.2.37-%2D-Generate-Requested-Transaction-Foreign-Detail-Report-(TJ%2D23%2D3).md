...
- TRRPT3 - The NMMSS shall be able to produce a requested transaction foreign detail report that will show detailed transaction data at a high level of detail for foreign exports and imports (TJ-23-3).