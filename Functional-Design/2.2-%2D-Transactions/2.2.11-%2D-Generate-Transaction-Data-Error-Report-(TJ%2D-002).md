...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/645/" target="_blank">TRRPT6</a> - The NMMSS shall be able to produce a transaction data error report (TJ-002). The error report identifies each data discrepancy detected in the initial data input and edit processing stage. These transactions will not continue to the database updating process due to the fatal nature of the discrepancy.