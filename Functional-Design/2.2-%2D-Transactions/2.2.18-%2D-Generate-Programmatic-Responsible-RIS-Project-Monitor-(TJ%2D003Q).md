This function produces a formatted report of any RIS that is not the programmatic RIS that has submitted a transaction against a project number belonging to some other RIS.
