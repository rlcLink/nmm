<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/186/" target="_blank">2.2.48 - Generate 741 Simulated Report - SAMS Only</a> - This report will list the entire transaction for a transfer series.
...
<a href="https://dev.azure.com/Link-Technologies/NMMSS%20Requirements/_workitems/edit/672/" target="_blank">TRRPT75 </a> - The NMMSS shall have the ability to produce a 741 simulated report that will list the entire transaction for a transaction series. Options for printing this report shall include shipper data only, shipper and receiver information, shipper information with unfilled receiver lines, receiver information with unfilled shipper lines, or receiver data only.
